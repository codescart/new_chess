...
class S {
  ...
  String get loading_moves_web {
    return Intl.message("Loading..", name: 'loading_moves_web');
  }
...
void pj(winner) async{
  if(winner.toString().toLowerCase()=="white"){
    final res= await http.get(
      Uri.parse('https://apponrent.co.in/chess/api/winamount.php?winnig_id=$uid'),
    );
    final data=json.decode(res.body);
  }
  if(winner.toString().toLowerCase()=="black"){
    final res= await http.get(
      Uri.parse('https://apponrent.co.in/chess/api/winamount.php?winnig_id=$oid'),
    );
    final data=json.decode(res.body);
  }
}
